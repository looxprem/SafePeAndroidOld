...
public class ForgotPassword extends AppCompatActivity {
    ...
    void conformPassword(){
        ...
        if(TextUtils.isEmpty(str_edit_conf_pass)){
            ...
            enter_password.setError("Please Enter Valid Password");
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (jsonObject.optString("Status").equalsIgnoreCase("Success")) {
                    ...
                    Toast.makeText(ForgotPassword.this, "Something went wrong please contact to administrator", Toast.LENGTH_SHORT).show();
                }
            } catch (JSONException e) {
                e.printStackTrace();
            }
